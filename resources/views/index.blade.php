    ...
    <div class="flex flex-col items-center">
        <div class="flex content-center justify-center w-full">
            ...
            <form method="GET" action="{{ route('welcome') }}" class="w-full p-6">
                <!-- flex-col sur téléphone et flex-row pour moniteurs -->
                <div class="flex md:flex-col gap-4">
                    <!-- Filter by filiere -->
                    <select id="filiere-select" name="filiere" class="w-full sm:w-auto p-2 border border-gray-300 rounded">
                    ...
                    <!-- Filter by year -->
                    <select id="year-select" name="year" class="w-full sm:w-auto p-2 border border-gray-300 rounded">
                    ...
                    <!-- Filter by module -->
                    <select id="module-select" name="module" class="w-full sm:w-auto p-2 border border-gray-300 rounded">
        ...
        <!-- questions -->
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-full flex-1 p-6">
